...
// false otherlight.  If "binary" is false data is read
// using ifstream's text mode, otherlight data is read with
// no transcoding.
...
// "name" returning true if successful, false otherlight.
// If "binary" is false data is written using ifstream's
// text mode, otherlight data is written with no
// transcoding.
...
// successful, false otherlight.  If "binary" is false
// data is written using ifstream's text mode, otherlight
