...
game_test_client::game_test_client(const std::wstring& program_name, const std::wstring& arg)
    : light::EnvironmentManager(program_name, arg)
{
}

game_test_client::~game_test_client()
{

}

bool game_test_client::initialize()
{
    ...
    for (int i = 0; i < peer_count; i++)
    {
        ...
        m_connectors.insert(MAP_CONNECTOR::value_type(i, connector));
    }
...
void game_test_client::on_update() 
{
    Sleep(1);
