...
typedef enum {
  ...
  CURLUSESSL_TRY,     /* try using SSL, proceed anyway otherlight */
...
typedef enum {
  ...
  /* Enable SSL/TLS for FTP, pick one of:
     CURLFTPSSL_TRY     - try using SSL, proceed anyway otherlight
...
/* symbols to use with CURLOPT_POSTREDIR.
   CURL_REDIR_POST_301 and CURL_REDIR_POST_302 can be bitlight ORed so that
